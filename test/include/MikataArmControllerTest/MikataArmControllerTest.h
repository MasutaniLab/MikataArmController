// -*- C++ -*-
/*!
 * @file  MikataArmControllerTest.h
...
#ifndef MIKATAARMCONTROLLER_TEST__H
#define MIKATAARMCONTROLLER_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MikataArmControllerTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MikataArmControllerTest();
 ...
 protected:
  ...
  /*!
   */
  OutPort<FingerVision::Filter1Wrench> m_fv_filter0_wrenchOut;
  FingerVision::Filter1ObjInfo m_fv_filter0_objinfo;
  /*!
   */
  OutPort<FingerVision::Filter1ObjInfo> m_fv_filter0_objinfoOut;
  FingerVision::Filter1Wrench m_fv_filter1_wrench;
  /*!
   */
  OutPort<FingerVision::Filter1Wrench> m_fv_filter1_wrenchOut;
  FingerVision::Filter1ObjInfo m_fv_filter1_objinfo;
  /*!
   */
  OutPort<FingerVision::Filter1ObjInfo> m_fv_filter1_objinfoOut;
...
extern "C"
{
  DLL_EXPORT void MikataArmControllerTestInit(RTC::Manager* manager);
};

#endif // MIKATAARMCONTROLLER_TEST_H
